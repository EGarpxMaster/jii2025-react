...
const RegistroComponent: React.FC<RegistroComponentProps> = ({
  ...
  async function checkEmailUnique(email: string): Promise<boolean> {
    try {
      const url = `${API_URL}/check-email?email=${encodeURIComponent(email)}`;
    ...
    try {
      ...
      if (res.status === 409) {
        ...
        if (err?.field === "email") {
          ...
          alert(err?.error || "Conflicto al registrar");
        }
        return;
      }
      ...
      if (!res.ok) {
        ...
        try {
          ...
          alert(j?.error || "Ocurrió un error. Intenta de nuevo.");
        } catch {
      ...
      setSubmitted(true);
      onSuccess ? onSuccess() : setTimeout(() => (window.location.href = "/"), 3000);
    } catch {
      ...
      <div className="registro-container">
        {!submitted ? (
                ...
                <div className="registro-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={`form-input ${
                        errors.apellidoPaterno ? "input-error" : ""
                      }`}
                      required
                    />
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={`form-input ${
                        errors.apellidoMaterno ? "input-error" : ""
                      }`}
                      required
                    />
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={`form-input ${
                        errors.primerNombre ? "input-error" : ""
                      }`}
                      required
                    />
                ...
                <div className="registro-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      className={`form-input ${
                        errors.email || emailStatus === "taken" ? "input-error" : ""
                      }`}
                      required
                    />
          ...
          <div className="success-message">
            ...
            <p>Gracias por registrarte. Serás redirigido a la página de inicio en unos segundos...</p>
          </div>
        )}
      </div>
    </section>
